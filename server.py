...
# Cache native species sets per country code (e.g. {'BE': {'eurnut', 'comchi', ...}})
...
def analyze_audio_request():
    ...
    try:
        ...
        for label, score in results_map.items():
            ...
            # eBird Regional Filter:
            # If native eBird list exists for country, discard species not in region unless score > 85%
            if is_filtered and species_code.lower() not in native_species_set and score < 0.85:
                continue
